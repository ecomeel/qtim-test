...
import ArticlesList from '~/src/widgets/articles/ui/ArticlesList.vue';
import Pagination from '~/src/shared/ui/Pagination.vue';
import { useArticlePagination } from '~/src/features/article-pagination/model/useArticlePagination';
